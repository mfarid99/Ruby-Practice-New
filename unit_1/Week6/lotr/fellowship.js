...
const makeMiddleEarth = (() => {
        ...
        for (names of lands) {
        let $article = $('<article>').attr('id', names)
        $('body').append($article)
  ...
  // 2. append the section to the body of the DOM. Ok
...
const $frodobag = $('#the-fellowship').children().not('h1').eq(0)
const $samW = $('#the-fellowship').children().not('h1').eq(1)


const itsDangerousToGoAlone = (() => {
  
  $('#Mordor').append($frodobag)
  $('#Mordor').append($samW)
